...
class DiscoverApi {
  /// 获取 APP 首页信息
  static Future<DiscoverModel?> getHomePage({bool refresh = false,String? cursor}) async {
    ...
    if (response.result) {
      ...
      // Application.sp?.setString(HOME_PAGE_DATA, json.encode(discoverModel.toJson()));
